...
<body>
	<div>						
		<form action="amendOrg.do" method="post">
			<input type="hidden" name="id" value="${org.id}">
			<input type="hidden" name="create_time" value="${org.create_time}">
		上级机构：
		...
		电话号码:
			...
			<br>
		邮政编码:
			<input type="text" name="post_code" value="${org.post_code}">
			<br>
		传真号:&nbsp&nbsp&nbsp
			<input type="text" name="fax" value="${org.fax}">
			<br>
			<input type="submit" >
		</form>
	</div>
